...
class _AppSettingsState extends State<AppSettings> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      startTime = sharedPreferences.getString("START_TIME");
  ...
  _selectTime(type) async {
    ...
    final String timeType = type == 'START_TIME' ? 'START_TIME' : 'END_TIME';

    if (newTime != null) {
      setState(() {
        _time = newTime;
        _save(timeType, newTime.toString());
        if ('START_TIME' == timeType) {
